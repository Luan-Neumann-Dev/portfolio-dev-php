...
<?php foreach($projects as $project): ?>
    <div class="bg-slate-800 rounded-lg p-3 flex items-center space-x-3">
        <div class="w-1/5 flex items-center justify-middle">
            <img src="<?= $project['img'] ?>" class="w-42 rounded-md">
        </div>
        <div class="w-4/5 space-y-3">
            <div class="flex gap-3 justify-between">
                <h3 class="font-semibold text-xl">
                    ...
                    <?= $project['title'] ?>
                    <?php if ($project['finished']): ?>
                        <span class="text-xs text-grey-400 opacity-50 italic">( Finalizado em <?= $project['year'] ?> )</span></h3>
                    <?php else: ?>
                    ...
                    <div class="space-x-1">
                        <?php
                            ...
                            foreach($project['stack'] as $posicao => $language):
                        ?>
